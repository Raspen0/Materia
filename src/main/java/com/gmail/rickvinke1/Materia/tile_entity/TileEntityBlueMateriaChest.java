...
public class TileEntityBlueMateriaChest extends TileEntityChest{
	...
	private int cachedChestType;
	 ...
	 public TileEntityBlueMateriaChest adjacentChestZNeg;
	    ...
	    private void func_145978_a(TileEntityBlueMateriaChest p_145978_1_, int p_145978_2_)
	    {
	    ...
	    public void checkForAdjacentChests()
	    {
	        if (!this.adjacentChestChecked)
	        {
	            ...
	            {
	                this.adjacentChestXNeg = (TileEntityBlueMateriaChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
	            }

	            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
	            {
	                this.adjacentChestXPos = (TileEntityBlueMateriaChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
	            }

	            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
	            {
	                this.adjacentChestZNeg = (TileEntityBlueMateriaChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
	            }

	            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
	            {
	                this.adjacentChestZPos = (TileEntityBlueMateriaChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
	            }
