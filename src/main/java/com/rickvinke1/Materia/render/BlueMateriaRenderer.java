...
public class BlueMateriaRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation field_147504_g =
    		new ResourceLocation(Strings.MODID + ":textures/blocks/BlueMateriaChest.png");
    private ModelChest field_147510_h = new ModelChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public BlueMateriaRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityBlueMateriaChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlueMateriaChest && i == 0)
            {
                try
                {
                ((BlueMateriaChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
